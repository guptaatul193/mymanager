...
hdr = 'Product ID,Product Name,Product Description,Date Added,Date Discontinued,Stock'
hdr_dict = { '1':'usrnm' , '2':'lvl' , '3':'mob' }

class Product:
	
	def __init__ ( self , prodid, prodnm, proddesc, dateadded, datedisc, stock ):

		self.prodid = prodid
		self.prodnm =  prodnm
		self.proddesc = proddesc
		self.dateadded = dateadded
		self.datedisc = datedisc
		self.stock = stock
